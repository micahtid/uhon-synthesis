  ...
  return (
    <main className="min-h-screen py-32 overflow-x-hidden bg-background relative">
      ...
      <header className="mb-32 px-6 text-center relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 text-sm font-medium tracking-wide text-gray-600">
          <span className="px-3 py-1 rounded-full bg-white/60 backdrop-blur-sm shadow-sm border border-gray-200">
            Micah, Matthew, Adam & Aruneem
          </span>
        </div>
      </header>
